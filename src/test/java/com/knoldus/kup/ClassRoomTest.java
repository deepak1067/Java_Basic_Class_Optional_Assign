...
public class ClassRoomTest {
    ...
    public void setUpClassRoom() throws Exception {
        Student student1 = new Student("Shashi", 1, Optional.of("PHP"));
        Student student2 = new Student("Krishna", 2, Optional.empty());
        Student student3 = new Student("Aasif", 3, Optional.empty());
        Student student4 = new Student("Rohit", 4, Optional.of("JAVA"));

        Student student5 = new Student("Udit", 5, Optional.of("C++"));
        Student student6 = new Student("Bhavya", 6, Optional.of("ANGULAR"));
        Student student7 = new Student("Prakhar", 7, Optional.of("HTML"));
        Student student8 = new Student("Amit", 10, Optional.of("REACT"));
        Student student9 = new Student("Ravi", 11, Optional.of("C"));
